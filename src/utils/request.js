...
// 单个请求 存在请求超时
export async function req(params, options, delay = GLOBAL_DELAY) {
...
// GET request
export async function getRequest(url, param = {}, options = {}) {
  try {
...
// POST request
export async function postRequest(url, param = {}, options = {}) {
  try {
    const response = await req(
      {
        url,
